...
//    {
//        // Arrange
//        var manufacturers = new List<ManufacturerDto> { new(), new() };

//        _mediatorMock
//            .Setup(m => m.Send(new GetManufacturersQuery(), CancellationToken.None))
...
//        var value = okResult?.Value as List<ManufacturerDto>;
